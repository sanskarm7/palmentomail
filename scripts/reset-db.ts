...
async function main() {
  ...
  console.log("Initializing complete destructive wipe of Postgres ingestion tables and S3 Storage...");
  ...
  try {
    ...
    if (!process.env.NEXT_PUBLIC_SUPABASE_URL || !process.env.SUPABASE_SERVICE_ROLE_KEY) {
      console.warn("    Skipping S3 wipe globally: Missing SUPABASE_SERVICE_ROLE_KEY");
    } else {
